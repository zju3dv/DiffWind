...
class GaussianModel:
    ...
    def create_from_pcd(
        ...
        # Only training/point-cloud initialization needs simple-knn. Forward
        # simulation loads an existing Gaussian PLY and does not require it.
    ...
    def save_ply_partial(self, path, idx):
        mkdir_p(os.path.dirname(path))
